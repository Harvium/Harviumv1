...
export default function Modal() {
  ...
  return (
    <>
      <button onClick={toggleModal} className="rounded-md bg-#080E2D-100 px-5 py-2.5 text-sm font-medium text-white dark:bg-#080E2D-800 dark:text-white dark:hover:text-white/75">
        Rejestracja
      </button>
