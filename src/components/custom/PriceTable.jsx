            ...
            {isLoading ? (
              ...
              <Table className='rounded-lg border-2 border-white mt-5'>
                ...
                <TableHeader className="bg-violet-950/30">
                  <TableRow>
                  <TableHead className="w-[50px] text-white" onClick={() => requestSort('ProductName')}>
                    <span>Produkt</span>
                  ...
                  <TableHead className="w-[50px] text-white" onClick={() => requestSort('Data')}>Data notowania</TableHead>
                  <TableHead className="w-[50px] text-white" onClick={() => requestSort('AvgPrice')}>Ostatnia cena</TableHead>
                  <TableHead className="w-[50px] text-white" onClick={() => requestSort('Change')}>Zmiana</TableHead>
                  <TableHead className="w-[50px] text-white" onClick={() => requestSort('AvgPrice')}>Cena kupna</TableHead>
                  <TableHead className="w-[50px] text-white" onClick={() => requestSort('AvgPrice')}>Cena sprzedaży</TableHead>
                </TableRow>
              </TableHeader>
