          ...
          <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            >
              <svg
                ...
                className="size-10 text-purple-900"
                fill="purple"
            ...
            >
              ...
              <h2 className="mt-4 text-2xl font-bold text-white">Tworzymy rynek</h2>
            ...
            >
              ...
              <h2 className="mt-4 text-2xl font-bold text-white">Monitorujemy ceny</h2>
            ...
            >
              ...
              <h2 className="mt-4 text-2xl font-bold text-white">Rolnictwo precyzyjne</h2>
